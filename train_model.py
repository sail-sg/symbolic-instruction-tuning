...
def main():
    ...
    def compute_metrics(eval_preds):
        ...
        assert data_args.eval_func is not None
        eval_func_name = data_args.eval_func
        eval_func = globals()[eval_func_name]
        print("Evaluating using {} ...\n".format(eval_func_name))
        result = eval_func(predictions=decoded_preds, references=decoded_labels)
        return {eval_func_name: result}
